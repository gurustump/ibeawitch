...
function __construct() {
	...
	__('Blank Widget', 'blank_widget_domain'), 
	 
	// Widget description
	array( 'description' => __( 'Blank widget for adding some html to the sidebar', 'blank_widget_domain' ), )
	);
}
...
public function widget( $args, $instance ) {
	...
	echo __( 'Hello, World!', 'blank_widget_domain' );
...
public function form( $instance ) {
	...
	$title = __( 'New title', 'blank_widget_domain' );
	}
	// Widget admin form
	?>
	<p>
